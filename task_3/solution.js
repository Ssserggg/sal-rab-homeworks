function renderCartItem(item) {
    ...
    let item = {id: id, title: title, count: count, price: price};// product - объект вида {id: id, title: title, count: count, price: price}
    ...
    itemCountText = itemCountText + pitem.price;// 4. Присвойте переменной itemCountText результат склеивания itemCountText и цены
